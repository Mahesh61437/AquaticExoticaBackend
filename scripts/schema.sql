...
ALTER TABLE IF EXISTS ONLY public.token_blacklist_outstandingtoken DROP CONSTRAINT IF EXISTS token_blacklist_outs_user_id_83bc629a_fk_core_user;
...
ALTER TABLE IF EXISTS ONLY public.django_aws_ses_awssesuseraddon DROP CONSTRAINT IF EXISTS django_aws_ses_awssesuseraddon_user_id_4f425185_fk_core_user_id;
ALTER TABLE IF EXISTS ONLY public.django_aws_ses_awssessettings DROP CONSTRAINT IF EXISTS django_aws_ses_awsse_site_id_b143ec4f_fk_django_si;
...
ALTER TABLE IF EXISTS ONLY public.core_shippingaddress DROP CONSTRAINT IF EXISTS core_shippingaddress_user_id_da3e3bad_fk_core_user_id;
...
ALTER TABLE IF EXISTS ONLY public.core_productimage DROP CONSTRAINT IF EXISTS core_productimage_product_id_10178291_fk_core_product_id;
ALTER TABLE IF EXISTS ONLY public.core_product_tags DROP CONSTRAINT IF EXISTS core_product_tags_tag_id_038dc8df_fk_core_tag_id;
ALTER TABLE IF EXISTS ONLY public.core_product_tags DROP CONSTRAINT IF EXISTS core_product_tags_product_id_7fa1e736_fk_core_product_id;
ALTER TABLE IF EXISTS ONLY public.core_product_categories DROP CONSTRAINT IF EXISTS core_product_categories_product_id_419fa40f_fk_core_product_id;
ALTER TABLE IF EXISTS ONLY public.core_product_categories DROP CONSTRAINT IF EXISTS core_product_categor_category_id_1263db5a_fk_core_cate;
...
ALTER TABLE IF EXISTS ONLY public.core_order DROP CONSTRAINT IF EXISTS core_order_user_id_b03bbffd_fk_core_user_id;
ALTER TABLE IF EXISTS ONLY public.core_order DROP CONSTRAINT IF EXISTS core_order_shipping_address_id_8c054f15_fk_core_ship;
...
ALTER TABLE IF EXISTS ONLY public.core_cart DROP CONSTRAINT IF EXISTS core_cart_user_id_2ebeb843_fk_core_user_id;
ALTER TABLE IF EXISTS ONLY public.core_appnotification DROP CONSTRAINT IF EXISTS core_appnotification_user_id_444805b0_fk_core_user_id;
...
ALTER TABLE IF EXISTS ONLY public.core_stocknotification DROP CONSTRAINT IF EXISTS core_stocknotification_email_product_id_ebe74a60_uniq;
...
CREATE TABLE public.core_stocknotification (
    ...
    CONSTRAINT core_stocknotification_product_id_check CHECK ((product_id >= 0))
);
...
--
-- Name: core_stocknotification core_stocknotification_email_product_id_ebe74a60_uniq; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.core_stocknotification
    ADD CONSTRAINT core_stocknotification_email_product_id_ebe74a60_uniq UNIQUE (email, product_id);
...
CREATE INDEX django_aws_ses_blacklisteddomains_domain_53c96db6_like ON public.django_aws_ses_blacklisteddomains USING btree (domain varchar_pattern_ops);
...
CREATE INDEX django_aws_ses_bouncerecord_email_a6dd5e2c_like ON public.django_aws_ses_bouncerecord USING btree (email varchar_pattern_ops);
...
CREATE INDEX django_aws_ses_complaintrecord_email_a1980dd0_like ON public.django_aws_ses_complaintrecord USING btree (email varchar_pattern_ops);
...
CREATE INDEX django_aws_ses_sendrecord_destination_7eba4f0a_like ON public.django_aws_ses_sendrecord USING btree (destination varchar_pattern_ops);
...
--
-- Name: core_appnotification core_appnotification_user_id_444805b0_fk_core_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.core_appnotification
    ADD CONSTRAINT core_appnotification_user_id_444805b0_fk_core_user_id FOREIGN KEY (user_id) REFERENCES public.core_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: core_cart core_cart_user_id_2ebeb843_fk_core_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: core_order core_order_shipping_address_id_8c054f15_fk_core_ship; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.core_order
    ADD CONSTRAINT core_order_shipping_address_id_8c054f15_fk_core_ship FOREIGN KEY (shipping_address_id) REFERENCES public.core_shippingaddress(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: core_order core_order_user_id_b03bbffd_fk_core_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: core_product_categories core_product_categor_category_id_1263db5a_fk_core_cate; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.core_product_categories
    ADD CONSTRAINT core_product_categor_category_id_1263db5a_fk_core_cate FOREIGN KEY (category_id) REFERENCES public.core_category(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: core_product_categories core_product_categories_product_id_419fa40f_fk_core_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.core_product_categories
    ADD CONSTRAINT core_product_categories_product_id_419fa40f_fk_core_product_id FOREIGN KEY (product_id) REFERENCES public.core_product(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: core_product_tags core_product_tags_product_id_7fa1e736_fk_core_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.core_product_tags
    ADD CONSTRAINT core_product_tags_product_id_7fa1e736_fk_core_product_id FOREIGN KEY (product_id) REFERENCES public.core_product(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: core_product_tags core_product_tags_tag_id_038dc8df_fk_core_tag_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.core_product_tags
    ADD CONSTRAINT core_product_tags_tag_id_038dc8df_fk_core_tag_id FOREIGN KEY (tag_id) REFERENCES public.core_tag(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: core_productimage core_productimage_product_id_10178291_fk_core_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: core_shippingaddress core_shippingaddress_user_id_da3e3bad_fk_core_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.core_shippingaddress
    ADD CONSTRAINT core_shippingaddress_user_id_da3e3bad_fk_core_user_id FOREIGN KEY (user_id) REFERENCES public.core_user(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: django_aws_ses_awssessettings django_aws_ses_awsse_site_id_b143ec4f_fk_django_si; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.django_aws_ses_awssessettings
    ADD CONSTRAINT django_aws_ses_awsse_site_id_b143ec4f_fk_django_si FOREIGN KEY (site_id) REFERENCES public.django_site(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: django_aws_ses_awssesuseraddon django_aws_ses_awssesuseraddon_user_id_4f425185_fk_core_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.django_aws_ses_awssesuseraddon
    ADD CONSTRAINT django_aws_ses_awssesuseraddon_user_id_4f425185_fk_core_user_id FOREIGN KEY (user_id) REFERENCES public.core_user(id) DEFERRABLE INITIALLY DEFERRED;
