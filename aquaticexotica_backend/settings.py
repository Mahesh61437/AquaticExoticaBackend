...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'aquaticexotica_backend.pagination.StandardResultsSetPagination',
    'PAGE_SIZE': 10,
...
EMAIL_HOST_PASSWORD = config("EMAIL_HOST_PASSWORD", default="")  # NOT your gmail password
